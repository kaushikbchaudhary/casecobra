...
function Review({ imgSrc, className, ...props }: ReviewProps) {
    return (
        <div className={cn('animate-fade-in rounded-[2.25rem] bg-white p-6 opacity-0 shadow-slate-900/5',
            className 
        )}  {...props}>
            <img src={imgSrc} className="object-cover w-full h-full" alt="testimonial image" />
            <div className="absolute w-full h-full opacity-0 bg-black z-10" />
        </div>
    )
}
