...
export default function Home() {
  return (
    <div className="bg-slate-50 dark:bg-slate-600">
        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                <img src="/snake-1.png " alt="snacke1" className="w-full" />
              </div>
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg-text-7xl">Your Image on a <span className="bg-green-600 px-2 text-white">Custom</span> Phone</h1>
              <p className="mt-8 text-lg lg:pr-10 mx-w-prose text-center lg:text-left text-balance md:text-wrap">Capture your favorite memories with your own, <span className="font-semibold">one-of-one </span>
                Phone case.
          ...
          lg:mx-0 lg:mt-20 h-fit ">
            <div className="relative md:max-w-xl ">
              ...
              <img src="/line.png" alt="my image" className="absolute w-20 -left-6 -bottom-6 select-none" />
      ...
      <section className="bg-slate-100 py-24 dark:bg-slate-500">
        <MaxWidthWrapper className={'flex flex-col items-center gap-16 sm:gap-32'}>
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            text-gray-900 ">What our <span className="relative px-2">customers <Icons.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-green-500"></Icons.underline></span> say</h2>
            <img src="/snake-2.png" alt="snack img" className="w-24 order-0 lg:order-2" />
          </div>
            ...
            <div
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  design. Had the case for two and half monts now and <span
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Chaudhary</p>
            ...
            <div
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  some pretty heavy scratchmarks on all of my last phone cases. This one, besides a barely noticeable scratch on
                  the corner,{' '} <span
